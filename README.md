# Responsive Civic App

A lightweight civic routing and learning experience that helps people figure out **which public authority to approach for a real-world problem** in an Indian city.
...
A **search-first issue picker** where users can:
...
The Quiz is designed as a short civic reasoning exercise. Current quiz behavior:
...
The Learn page explains the structure of public responsibility in a clearer, less overwhelming way. It includes:
...
The app currently includes scenario data across multiple layers of government, not just municipal issues.
